...
if [ "$USEPURVIEW" = "Yes" ]; then
	...
	az ad app permission grant --id $PURVIEWCLIENTID --api 00000003-0000-0000-c000-000000000000 --scope Group.Read.All
	az ad app permission grant --id $PURVIEWCLIENTID --api 00000003-0000-0000-c000-000000000000 --scope GroupMember.Read.All
	az ad app permission grant --id $PURVIEWCLIENTID --api 00000003-0000-0000-c000-000000000000 --scope User.Read.All
fi
