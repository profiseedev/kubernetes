...
echo "nginxip:$nginxip" > $AZ_SCRIPTS_OUTPUT_PATH
echo "azureAppReplyUrl:$azureAppReplyUrl" > $AZ_SCRIPTS_OUTPUT_PATH
echo "azureClientName:$azureClientName" > $AZ_SCRIPTS_OUTPUT_PATH
echo "azureClientId:$azureClientId" > $AZ_SCRIPTS_OUTPUT_PATH
